...
export const myProjects = [
    {
        ...
        texture: '/textures/project/Xora_Demo_Least_Qality.mp4',
...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
        ...
        cubePosition: isSmall ? [4, -5, 0] : isMobile ? [5, -5, 0] : isTablet ? [10, -5, 0] : [9, -5.5, 0],
        reactLogoPosition: isSmall ? [3, 4, 0] : isMobile ? [5, 4, 0] : isTablet ? [12, 3, 0] : [12, 2.5, 2.5],
        ringPosition: isSmall ? [-5, 7, 0] : isMobile ? [-15, 15, 0] : isTablet ? [-25, 10, 0] : [-24, 10, 0],
